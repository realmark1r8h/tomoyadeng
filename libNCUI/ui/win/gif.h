...
static int GifPartition(uint8_t* image, const int left, const int right, const int elt,
                        int pivotIndex) {
...
static void GifSplitPalette(uint8_t* image, int numPixels, int firstElt, int lastElt,
...
static void GifThresholdImage(const uint8_t* lastFrame, const uint8_t* nextFrame,
                              uint8_t* outFrame, uint32_t width, uint32_t height, GifPalette* pPal) {
...
static void GifWriteLzwImage(FILE* f, uint8_t* image, uint32_t left, uint32_t top,
...
static bool GifBegin(GifWriter* writer, const char* filename, uint32_t width,
...
static bool GifWriteFrame(GifWriter* writer, const uint8_t* image, uint32_t width,
