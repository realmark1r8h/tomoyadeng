...
namespace amo {
    ...
    public:
        ...
        AMO_CEF_MESSAGE_TRANSFER_FUNC(target, TransferFuncClassProperty | TransferExecSync)
        AMO_CEF_MESSAGE_TRANSFER_FUNC(data, TransferFuncClassProperty | TransferExecSync)
