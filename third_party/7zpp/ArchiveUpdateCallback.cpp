...
namespace SevenZip {
    namespace intl {
        ...
        ArchiveUpdateCallback::ArchiveUpdateCallback(const TString& dirPrefix,
                const std::vector< FilePathInfo >& filePaths, const TString& outputFilePath,
        ...
        STDMETHODIMP ArchiveUpdateCallback::QueryInterface(REFIID iid,
                void** ppvObject) {
        ...
        STDMETHODIMP ArchiveUpdateCallback::GetProperty(UInt32 index, PROPID propID,
                PROPVARIANT* value) {
            CPropVariant prop;
        ...
        STDMETHODIMP ArchiveUpdateCallback::GetStream(UInt32 index,
        ...
        STDMETHODIMP ArchiveUpdateCallback::CryptoGetTextPassword2(
        ...
        STDMETHODIMP ArchiveUpdateCallback::SetRatioInfo(const UInt64* inSize,
