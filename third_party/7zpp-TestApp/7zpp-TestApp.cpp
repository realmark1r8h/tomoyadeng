...
#define  PPP L"E:\\中文目录\\NCUI-Out\\Binary.UD32\\"

#define DLL_PATH  PPP L"7z.dll"
#define TEMPDIR PPP L"tmp"
#define TESTEXTRACTTESTFILE1 PPP L"TestFiles\\files.zip"
#define TESTEXTRACTTESTFILE2 PPP L"TestFiles\\Readme.txt.gz"
#define TESTEXTRACTTESTFILE3 PPP L"TestFiles\\Readme.txt"
#define TESTEXTRACTTESTFILE4 PPP L"TestFiles\\7z.zip"
...
TEST(Init, LoadDLL) {
    ...
    std::string ss = amo::system::getLastErrorMessage();
    amo::loader loader;
...
public:
    ...
    virtual void OnDone(SevenZip::TString filePath) override {
        std::wcout << __FUNCTION__ << filePath <<   std::endl;
    }
...
ProgressCallbackOutput* callback = new ProgressCallbackOutput();
void foo() {
