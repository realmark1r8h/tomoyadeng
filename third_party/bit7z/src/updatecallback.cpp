...
STDMETHODIMP UpdateCallback::SetRatioInfo(const UInt64* inSize,
...
HRESULT UpdateCallback::GetProperty(UInt32 index, PROPID propID,
                                    PROPVARIANT* value) {
    ...
    switch (propID) {
    case kpidPath:
        prop = dirItem.relativePath().c_str();
        break;
...
HRESULT UpdateCallback::GetStream(UInt32 index,
...
HRESULT UpdateCallback::GetVolumeStream(UInt32 index,
